...
;~function(global) {
	...
	var FLOOR_WIDTH = 100, FLOOR_HEIGHT = 10, FLOOR_DISTANCE = 60;
	var SPRING_HEIGHT = FLOOR_HEIGHT - 4;
	var HERO_WIDTH = 40;
	var ARROW_HEIGHT = 20, ARROW_WIDTH = 5; // 釘子尺寸
	...
	var FAKE_FLOOR_TIME = 300, FAKE_FLOOR_TIME2 = 600; // 翻面地板的停留時間, 轉動時間
